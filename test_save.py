...
class SaveTestCase(unittest.TestCase):
    def test_save(self):
        ...
        save.board.Save('test_output_mcu.kicad_pcb')
        footprint_refs = {footprint.GetReference() for footprint in save.board.GetFootprints()}
        self.assertEqual(footprint_refs, {'U2', 'C3', 'C4', 'C5', 'C6', 'C7', 'C8', 'J2'})
        self.assertEqual(save.board.GetAreaCount(), 0)
